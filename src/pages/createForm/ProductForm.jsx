...
export const ProductForm = ({ onSubmit }) => {
  ...
  const validateCategory = (value) => {
    ...
    return (
      ...
      "Categoría inválida. Por favor utiliza otra categoría."
    );
  };
    ...
    <form onSubmit={handleSubmit(submitForm)}>
      ...
      <div>
        ...
        <input
          ...
          {...register("cost", {
            required: true,
            min: { value: 0.01, message: "El costo debe ser mayor a cero." },
          })}
          placeholder="Costo"
        />
      ...
      <div>
        <label className={styles.label} htmlFor="activeStatus">
          Activo Status:
        </label>
        <select
          id="activeStatus"
        ...
        {errors.activeStatus && (
          <p>Se requiere que estes activo en tu status.</p>
        )}
      </div>
